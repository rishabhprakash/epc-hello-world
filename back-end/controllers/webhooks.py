...
from services.zipcode import verify_with_usps, verify_with_ss
from utilities.constants import HMAC_KEY

# Placeholder - TODO: verify signature + process notification
def process(body):
    ...
    if event_type == 'created' and resource_type == 'urn:elli:epc:transaction':
        ...
        request_processor = threading.Thread(target=verify_with_usps, args=(transaction_id, app.request_tracker,access_token,))
